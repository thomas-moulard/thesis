...
La section précédente a introduit le formalisme et les outils que nous
allons utiliser pour poser le problème de manière formelle.
...
de peignes a toutefois des inconvénients qui seront détaillés dans la
...
en préservant un typage fort est une tâche ardue et complexe; de ce
fait, un compromis entre ergonomie et effort de modélisation a été
...
dont on aurait souhaité garder une formalisation plus proche de leurs
natures mathématiques véritables.
