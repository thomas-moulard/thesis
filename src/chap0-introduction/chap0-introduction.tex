...
des capteurs, l'année 2010 a été l'année de la Kinect\index{Kinect
  (Microsoft)}. Ce capteur destiné à la console de jeux Xbox 360 de
...
la recherche scientifique tel que le Swiss Ranger\index{Swiss Ranger}
...
soit-elle, ce robot, le PR2\index{PR2 (robot)}, bénéficie de tests de
...
totalement original et sur lequel, à notre connaissance, aucun papier
...
l'équipe LAGADIC de l'IRISA à Rennes. L'apport original de cette
