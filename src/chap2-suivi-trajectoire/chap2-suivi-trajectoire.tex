...
\cite{08siciliano} détaillant la plupart des algorithmes
...
également citer \cite{05thrun}, pour la vision
robotique \cite{03hartley} et pour la planification de
mouvements \cite{06lavalle}. Les fondements mathématiques de
...
l'utilisation du ZMP pour la robotique \cite{04vukobratovic.ijhr}. Un
...
est \cite{04harada.humanoids,01kajita.icra,07morisawa.icra}.
