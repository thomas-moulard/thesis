...
La marche est effectué en boucle ouverte et l'erreur d'exécution n'est
...
\begin{figure}
  \begin{center}
    \includegraphics[width=.45\linewidth]{src/chap3-primitive-mouvement/mocap.png}
  \end{center}
  \caption{Précision de l'algorithme de SLAM par rapport au système de capture de mouvemement.}
\end{figure}
