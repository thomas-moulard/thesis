  ...
  \begin{changeleftmargin}{1.1cm}
   ...
   \note[item]{INTERFACES: nécessaire de dériver les classes
    ...
    \begin{tikzpicture}[auto]
      ...
      (Fonction.south) -- (Fonction dérivable.north);
      \path[draw=\umldrawcolor, open triangle 45-, ultra thick]
      (Fonction dérivable.south) -- (Fonction dérivable deux fois.north);
    \end{tikzpicture}
    \end{center}
  \end{changeleftmargin}
\end{slideDecision}
...
\begin{slideDecision}
  \begin{changeleftmargin}{1.1cm}
    ...
    \begin{tikzpicture}[auto]
      ...
      \path[draw=\umldrawcolor, open triangle 45-, ultra thick]
      (Fonction dérivable deux fois.south) node[below right] {$n=3$}
      -- (Fonction dérivable ``n'' fois.north);

      \path[draw=\umldrawcolor, open triangle 45-, ultra thick]
      (Fonction dérivable ``n'' fois.south)
      -- ++(0, -1)
      -- ++(-1, 0) node[below] {$n > 3$}
      -- ++(0, 1);
...
\begin{slideDecision}
  \begin{changeleftmargin}{1.1cm}
    ...
    \begin{center}
      ...
      \path[draw=\umldrawcolor, open triangle 45-, ultra thick]
      (F.south) -- (DifférencesFinies.north);
      \end{tikzpicture}
    \end{center}
    \bigskip
...
\begin{slideAction}
  \frametitle{Contrôleur polyvalent}
...
\begin{slidePerception}
  ...
  \begin{changeleftmargin}{1.1cm}
    \begin{itemize}
      ...
      \item C++: \textasciitilde{} 100k lignes modifiées / Python: \textasciitilde{} 5k lignes
