...
\usetikzlibrary{shapes.arrows,chains,positioning,%
  matrix,patterns,shapes.multipart,positioning,arrows,external}
\tikzexternalize
...
\begin{frame}[plain]
  \begin{changemargin}{-1cm}{-1cm}
    \begin{center}
      \vspace{-0.1cm}
      \includemedia[%
        addresource=vid/karim-multi-contact.mp4,
        height=\paperheight,
        width=\paperwidth,
        flashvars={
          flv=vid/karim-multi-contact.mp4
          &autoPlay=true
      }]{%
        \includegraphics[height=\paperheight]{%
          src/slides/multi-014.jpg}}{player_flv_maxi.swf}
    \end{center}
  \end{changemargin}
\end{frame}
...
\begin{frame}[plain]
  \begin{changemargin}{-1cm}{-1cm}
    \begin{center}
      \vspace{-0.1cm}
      \includemedia[%
        addresource=vid/humanoids11-lbaudouin3.mp4,
        height=\paperheight,
        width=\paperwidth,
        flashvars={
          flv=vid/humanoids11-lbaudouin3.mp4
          &autoPlay=true
      }]{\includegraphics[height=\paperheight]{%
          src/slides/over.jpg}}{player_flv_maxi.swf}
    \end{center}
  \end{changemargin}
\end{frame}
...
\begin{slideAction}
  ...
  \note[item]{Complexe d'exprimer l'objectif d'un robot
    dans l'espace des configuration.}
  \note[item]{Espace des tâches: espace ``naturel''.}
  \note[item]{Prendre l'exemple d'un point 3D.}
  \note[item]{Jacobienne de la tâche.}
  \note[item]{Problème d'optimisation!}
  \note[item]{Cinématique inverse implicite\ldots}
...
\begin{slideAction}
  ...
  \note[item]{FIXME: descendre la courbe pour avoir
  une erreur au début}
...
\begin{slideAction}
  ...
  \note[item]{Polynôme déterminé complètement par les conditions
  limites.}
  \note[item]{Pile de pas discret. Trajectoire continue.}
...
\begin{frame}[plain]
  \begin{changemargin}{-1cm}{-1cm}
    \begin{center}
      \vspace{-0.1cm}
      \includemedia[%
        addresource=vid/biorob12.mp4,
        height=\paperheight,
        width=\paperwidth,
        flashvars={
          flv=vid/biorob12.mp4
          &autoPlay=true
      }]{%
        \includegraphics[height=\paperheight]{%
          src/slides/over.jpg}}{player_flv_maxi.swf}
...
\begin{frame}[plain]
  \begin{changemargin}{-1cm}{-1cm}
    \begin{center}
      \vspace{-0.1cm}
      \includemedia[%
        addresource=vid/hrp2-opening-door.mp4,
        height=\paperheight,
        width=\paperwidth,
        flashvars={
          flv=vid/hrp2-opening-door.mp4
          &autoPlay=true
      }]{%
        \includegraphics[height=\paperheight]{%
          src/slides/door.jpg}}{player_flv_maxi.swf}
    \end{center}
  \end{changemargin}
\end{frame}
